...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title mb-4">Edit Pengumuman</h4>
                <form class="needs-validation" method="post" action="{{ route('pengumuman.update', ['id' => $data->id]) }}" enctype="multipart/form-data" novalidate>
                @csrf
                    <div class="position-relative mt-4 mb-3">
                        <label class="form-label">Judul</label>
                        <input type="text" class="form-control @error('judul') is-invalid @enderror" placeholder="Judul" name="judul" value="{{ $data->judul }}" />
                        @error('judul')
                    ...
                    <div class="position-relative mt-4 mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal') is-invalid @enderror" placeholder="tanggal" name="tanggal" value="{{ $data->tanggal }}" />
                        @error('tanggal')
                            <span class="help-block">
                                <code>{{ $message }}</code>
                            </span>
                    ...
                    <div class="position-relative mt-4 mb-3">
                        ...
                        <textarea class="form-control @error('isi_pengumuman') is-invalid @enderror" name="isi_pengumuman" placeholder="Deskripsi">{{ $data->isi_pengumuman }}</textarea>
