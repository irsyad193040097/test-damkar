        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex flex-row justify-content-between mb-3">
                    <h4 class="header-title">Data Sliders</h4>
                    <a class="btn btn-primary text-white" href="{{ route('sliders.create') }}"><i class="mdi mdi-plus"></i> Tambah</a>
                </div>
    ...
    $('[data-tables=true]').on('click', '[data-button=delete-button]', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: "{{ url('admin/sliders/delete')  }}" + '/' + $(this).attr('data-id'),
                    type: "POST",
                    dataType: 'json',
